...
export default function BookmarkList() {
  ...
  if (posts.length === 0) {
    return (
      ...
      >
        <p style={{ fontSize: '15px' }}>아직 저장한 게시글이 없어요</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col">
          ...
          >
            ...
            >
              <div
                ...
                style={{ fontSize: '15.5px', fontWeight: 600, color: '#fff', letterSpacing: '-0.01em' }}
              >
                {post.title}
              </div>
              <div className="flex gap-1.5" style={{ fontSize: '11.5px', color: 'rgba(255,255,255,0.28)' }}>
      ...
      {isFetchingNextPage && <div className="py-4"><LoadingSpinner /></div>}
    </div>
  );
}
